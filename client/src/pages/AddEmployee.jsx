        ...
        <form onSubmit={handleSubmit}>
          <div className="row g-4">
            ...
            <div className="col-md-6">
              ...
              <input type="text" className="form-control" name="cnic" value={formData.cnic} onChange={handleChange} required placeholder="XXXXX-XXXXXXX-X" />
            </div>
            ...
            <div className="col-md-6">
              ...
              <input type="text" className="form-control" name="phone" value={formData.phone} onChange={handleChange} required placeholder="+1 234 567 8900" />
            </div>
            ...
            <div className="col-md-6">
              ...
              <input type="text" className="form-control" name="jobTitle" value={formData.jobTitle} onChange={handleChange} required placeholder="e.g. Software Engineer" />
            </div>
            ...
            <div className="col-md-6">
              ...
              <div className="input-group">
                ...
                <input type="number" className="form-control" name="salary" value={formData.salary} onChange={handleChange} required placeholder="5000" />
              </div>
            </div>
